...
public abstract class WormHead : Worm
{
	...
	/// <returns>The whoAmI of the most-recently spawned NPC, which is the result of calling <see cref="NPC.NewNPC(Terraria.DataStructures.IEntitySource, Int32, Int32, Int32, Int32, Single, Single, Single, Single, Int32)"/></returns>
